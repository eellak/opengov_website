...
<div id="comments" class="comments-area">
	...
	comment_form(
		array(
			...
			'comment_field' => '<div class="form-group">' . 
							...
							'</div>' . 
							'</div>',
			'comment_notes_after' => '<p class="help-block pull-right col-md-10">' . 
	...
	$comment_form = str_replace('class="form-submit', 'class="form-submit pull-right col-md-10',  $comment_form);
